<template>
  <div>
    <nav
      class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 border-b-2"
    >
      <div
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
          ...
          >
            <li>
              <Link
                :href="route('dashboard')"
                :class="{ 'text-blue-700': $page.props.menuHome }"
            ...
            <li>
              <Link
                ...
                :class="{ 'text-blue-700': $page.props.menuTasks }"
